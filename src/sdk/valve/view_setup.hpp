...
// below is ripped from the hl2src leak
...
public:
  ...
  // This does NOT override the Z range - that will be set up as normal (i.e. the values in this
  // matrix will be ignored).
  bool         m_bViewToProjectionOverride;
  v_matrix     m_ViewToProjection;
};